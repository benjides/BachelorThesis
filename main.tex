...
\thesistitle{Genre Music Classification Using Deep Learning} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\input{Extras/Abbreviations.tex}
\end{abbreviations}
